...
<table border="0" align="center" cellpadding="2" cellspacing="0">
                    ...
                    <td valign="top"><table width="460" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td align="center"><table width="460" border="0" cellpadding="10" cellspacing="1" bgcolor="#535891">
                          ...
                          <tr>
                            <td align="center" bgcolor="#FFFFFF" class="textotabla">Pobre <br />                              <img src="<%=request.getContextPath()%>/images/gr_estrellitaazul.gif" width="11" height="11" /></td>
  ...
  No se evidencian esfuerzos por    lograr los est&aacute;ndares ni superar a los competidores</td>
                          ...
                          <tr>
                            <td align="center" nowrap="nowrap" bgcolor="#FFFFFF" class="textotabla">Debajo del Est&aacute;ndar<br />                              <img src="<%=request.getContextPath()%>/images/gr_estrellitaazul.gif" width="11" height="11" /><img src="<%=request.getContextPath()%>/images/gr_estrellitaazul.gif" width="11" height="11" /></td>
                          ...
                          <tr>
                            <td align="center" bgcolor="#FFFFFF" class="textotabla">En el Est&aacute;ndar<br />                              <img src="<%=request.getContextPath()%>/images/gr_estrellitaazul.gif" width="11" height="11" /><img src="<%=request.getContextPath()%>/images/gr_estrellitaazul.gif" width="11" height="11" /><img src="<%=request.getContextPath()%>/images/gr_estrellitaazul.gif" width="11" height="11" /></td>
                          ...
                          <tr>
                            <td align="center" bgcolor="#FFFFFF" class="textotabla">Excepcional<br />                              <img src="<%=request.getContextPath()%>/images/gr_estrellitaazul.gif" width="11" height="11" /><img src="<%=request.getContextPath()%>/images/gr_estrellitaazul.gif" width="11" height="11" /><img src="<%=request.getContextPath()%>/images/gr_estrellitaazul.gif" width="11" height="11" /><img src="<%=request.getContextPath()%>/images/gr_estrellitaazul.gif" width="11" height="11" /></td>
