...
<table border="0" align="center" cellpadding="2" cellspacing="0">
  ...
  <tr>
    <td valign="top"><span class="menuMetas"><ul>
      ...
      <ol start="17">
        <li><a href="est17.html">Definición de estándares del tiempo de reparto a clientes especiales </a></li>
<li>Implementación de mejoras en el manejo del producto en locales de clientes especiales</li>
                ...
                <td valign="top"><table border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td valign="top"><table width="460" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td class="subtitulo">ENTREGA DEL PRODUCTO </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="10">
                          <tr>
                            <td width="10%" align="center" class="numero">18.</td>
                            <td class="nombreestandar">Implementaci&oacute;n de mejoras en el manejo del producto en locales de clientes especiales.</td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto" >La eficiencia en la operaci&oacute;n de reparto beneficia el servicio y el costo. Por lo tanto, las oportunidades para implementar cambios en el mercado e incentivar el uso equipos adecuados para el manejo de productos, deben ser ejecutadas. Los clientes necesitan ser informados de como tratar con la compa&ntilde;&iacute;a estos temas y qu&eacute; beneficios se pueden recibir. Se debe identificar la los clientes especiales (por ejemplo mayoristas, imagen) para &eacute;ste est&aacute;ndar.</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><table border="0" cellspacing="0" cellpadding="0">
                          <tr>
                        <td><a href="evidencias/18.1.xls" target="_blank"><img src="images/ic_excel.gif" alt="18.1.xls" width="75" height="71" border="0" /></a></td>
                        <td><a href="evidencias/18.2.jpg" target="_blank"><img src="images/ic_word.gif" alt="18.2.jpg" width="75" height="71" border="0" /></a></td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol><li> No existen procedimientos para evaluar e implementar acciones de mejora en el manejo del producto en el local del cliente.  </li>
                            <li> Se han realizado visitas a menos del 20% de los clientes escogidos para mejorar el manejo del producto en los &uacute;ltimos 6 meses. </li>
                        </ol></td></tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Existen procedimientos para evaluar e implementar acciones de mejora en el manejo del producto en el local del cliente.  </li>
                          <li> Se han realizado visitas entre el 21% y el 50% de los clientes escogidos para mejorar el manejo de producto en los &uacute;ltimos 6 meses. </li>
                        </ol></td></tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Existen procedimientos para evaluar e implementar acciones de mejora en el manejo del producto en el local del cliente. </li>
                          <li> Todos los clientes escogidos participaron en los &uacute;ltimos 6 meses en la identificaci&oacute;n de oportunidades para mejora en el manejo adecuado del producto y m&aacute;s del 51% ha sido activadas. </li>
                        </ol></td></tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Se ha analizado la conveniencia financiera y los beneficios reales de  las inversiones para mejora manejo de producto.</li></ol></td></tr>
                      <tr>
