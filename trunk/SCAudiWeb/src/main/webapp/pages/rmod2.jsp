                  ...
                  <tr>
                    <td background="../images/bg_menutopinterna.gif"><table border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td><a href="../pages/rmod1.jsp"><img src="../images/mnI_mod1.gif" name="mod1" width="92" height="64" border="0" id="mod1" onmouseover="MM_swapImage('mod1','','../images/mnI_mod1_roll.gif','mod1_2','','../images/mnI_active1_2.gif',1)" onmouseout="MM_swapImgRestore()" /></a></td>
                          ...
                          <td><a href="../pages/rmod3.jsp"><img src="../images/mnI_mod3.gif" name="mod3" width="102" height="64" border="0" id="mod3" onmouseover="MM_swapImage('mod2_3','','../images/mnI_active_2_3.gif','mod3','','../images/mnI_mod3_roll.gif','mod3_4','','../images/mnI_mod3_4_roll3.gif',1)" onmouseout="MM_swapImgRestore()" /></a></td>
                ...
                <td valign="top"><table border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td valign="top"><table width="511" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td colspan="2" class="titulo"><span class="stitModulo">MODULO 2</span><br />
                          Reposici&oacute;n Almacenamiento y Calidad - Regi&oacute;n Lima</td>
                      </tr>
                      <tr>
                        ...
                        <td width="261" align="left" valign="top" class="subtitulo">RED F10
                          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="242" height="210" align="middle" id="FlashID">
                            ...
                            <object data="Charts/AngularGauge.swf" type="application/x-shockwave-flash" width="242" height="210" align="middle">
                              ...
                              <param name="wmode" value="opaque" />
                              <param name="swfversion" value="8.0.35.0" />
                              <param name="FlashVars" value="&dataURL=Data/M2LimaF10.xml" />
                              <param name="expressinstall" value="Scripts/expressInstall.swf" />
                        ...
                        <td width="250" align="left" valign="top" class="subtitulo">RED F09
                          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="242" height="210" align="middle" id="FlashID3">
                            ...
                            <object data="Charts/AngularGauge.swf" type="application/x-shockwave-flash" width="242" height="210" align="middle">
                              ...
                              <param name="wmode" value="opaque" />
                              <param name="swfversion" value="8.0.35.0" />
                              <param name="FlashVars" value="&dataURL=Data/M2LimaF09.xml" />
                              <param name="expressinstall" value="Scripts/expressInstall.swf" />
                              <!-- The browser displays the following alternative content for users with Flash Player 6.0 and older. -->
                              <div>
                                <h4>Content on this page requires a newer version of Adobe Flash Player.</h4>
                      ...
                      <tr>
                        <td colspan="2" align="center" valign="top" class="texto"><object id="FlashID2" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="500" height="300">
                          ...
                          <object type="application/x-shockwave-flash" data="Charts/MSCombi2D.swf" width="500" height="300">
                            <!--<![endif]-->
                            <param name="quality" value="high" />
                            <param name="FlashVars" value="&dataURL=Data/M2DetalladoLima.xml" />
                            <param name="wmode" value="opaque" />
                            <param name="swfversion" value="8.0.35.0" />
                            <param name="expressinstall" value="Scripts/expressInstall.swf" />
                            <!-- The browser displays the following alternative content for users with Flash Player 6.0 and older. -->
                      ...
                      <tr>
                        <td colspan="2" align="center" valign="top" class="texto"><p class="tituloModulo">IM&Aacute;GENES</p>
                          <table width="484" height="388" border="0" align="center">
                            <tr>
                              <td width="251" align="left" valign="top"><img src="fotos/Modulo 2/1.jpg" width="246" height="186" /></td>
                              <td width="223" align="left" valign="top"><img src="fotos/Modulo 2/2.JPG" alt="" width="246" height="186" /></td>
                            </tr>
                            <tr>
                              <td align="left" valign="top"><img src="fotos/Modulo 2/3.JPG" width="246" height="186" /></td>
                              <td align="left" valign="top"><img src="fotos/Modulo 2/4.JPG" width="246" height="186" /></td>
                            </tr>
                          </table></td>
                      </tr>
                      <tr>
