            ...
            <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td valign="top"><table border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="10" align="left" valign="top"><img src="<%=request.getContextPath()%>/images/spacer.gif" width="10" height="31" /></td>
                    <td width="511"><img src="<%=request.getContextPath()%>/images/spacer.gif" width="460" height="10" /></td>
                    </tr>
