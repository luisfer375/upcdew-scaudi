...
<table border="0" align="center" cellpadding="2" cellspacing="0">
                  ...
                  <tr>
                    <td background="<%=request.getContextPath()%>/images/bg_menutopinterna.gif"><table border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td><img src="<%=request.getContextPath()%>/images/mnI_mod4_5_roll5.gif" name="mod4_5" width="19" height="64" id="mod4_5" /></td>
                          <td><img src="<%=request.getContextPath()%>/images/mnI_mod5_roll.gif" name="mod5" width="109" height="64" border="0" id="mod5"/></td>
                        </tr>
                    </table></td>
                  </tr>
                </table></td>
  ...
  <tr>
    <td align="center" bgcolor="#D2D2E2"><img src="<%=request.getContextPath()%>/images/spacer.gif" width="24" height="16" /></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="menuMetas"><ul>
      <li><a href="<%=request.getContextPath()%>/pages/estmod5_1.jsp">Servicio de reparto  </a></li>
      <li><a href="<%=request.getContextPath()%>/pages/estmod5_2.jsp">Calidad de producto y servicio </a></li>
      <li><a href="<%=request.getContextPath()%>/pages/estmod5_3.jsp">Compromiso con el cliente</a><a href="<%=request.getContextPath()%>/pages/est93.jsp"></a></li>
	  <li><a href="<%=request.getContextPath()%>/pages/estmod5_4.jsp">EVALUACI&Oacute;N GENERAL </a></li>
    </ul></td>
  </tr>
</table>
</td>
