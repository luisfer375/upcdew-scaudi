                    ...
                    <td valign="top"><table width="460" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td><table border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><a href="<%=request.getContextPath()%>/pages/evidencias/34.1.htm" target="_blank"><img src="images/ic_html.gif" alt="34.1.htm" width="75" height="71" border="0" /></a></td>
                            <td><a href="<%=request.getContextPath()%>/pages/evidencias/34.2.xls" target="_blank"><img src="images/ic_excel.gif" alt="34.2.xls" width="75" height="71" border="0" /></a></td>
                            <td><a href="<%=request.getContextPath()%>/pages/evidencias/34.3.xls" target="_blank"><img src="images/ic_excel.gif" alt="34.3.xls" width="75" height="71" border="0" /></a></td>
                            </tr>
                        </table>                          
                          </td>
                      </tr>
