  ...
  <tr>
    <td valign="top"><span class="menuMetas"><ul>
      <li>Planificaci&oacute;n de la carga.</li></ul></span><span class="menuMetasEst"><ol><li><a href="<%=request.getContextPath()%>/pages/est1.jsp">Conocimiento profundo del cliente y de los servicios que &eacute;stos requieren.</a></li>
        ...
        <li><a href="<%=request.getContextPath()%>/pages/est3.jsp">Optimizaci&oacute;n del ruteo y generaci&oacute;n del programa de entrega a clientes</a></li>
                    ...
                    <td valign="top"><table width="460" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td valign="top" class="texto"><table border="0" cellspacing="0" cellpadding="0">
                          <tr>
                        <td><a href="<%=request.getContextPath()%>/pages/evidencias/5.1.msg" target="_blank"><img src="images/ic_mail.gif" alt="5.1.msg" width="75" height="71" border="0" /></a></td>
                        ...
                        <td><a href="<%=request.getContextPath()%>/pages/evidencias/5.3.xls" target="_blank"><img src="images/ic_excel.gif" alt="5.3.xls" width="75" height="71" border="0" /></a></td>
                        <td><a href="<%=request.getContextPath()%>/pages/evidencias/5.4.xls" target="_blank"><img src="images/ic_excel.gif" alt="5.4.xls" width="75" height="71" border="0" /></a></td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
