              ...
              <tr>
                <td valign="top" class="menuizq"><br />
                  <ul>
                    ...
                    <li class="menuizq"><a href="pages/summary.jsp">Reportes </a></li>
                  </ul>
                  <br />
                  <br />                  <br />
                </td>
                <td valign="top"><table border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td valign="top"><table width="460" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td class="titulo">Bienvenido: Erick Tapia</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td align="center"><table width="407" height="96" border="0" align="center" cellpadding="8" cellspacing="0" bgcolor="#535891">
                          <tr>
                            <td width="97" align="center" valign="middle" class="tittabla"><p align="center">Auditor&iacute;as Pendientes</p></td>
                            <td width="62" align="center" valign="middle" nowrap="nowrap" class="tittabla"><p align="center">M&oacute;dulo</p></td>
                            <td width="76" align="center" valign="middle" class="tittabla"><p align="center">Fecha</p></td>
                            <td width="79" align="center" valign="middle" class="tittabla">Link</td>
                          </tr>
                          <tr>
