...
<table border="0" align="center" cellpadding="2" cellspacing="0">
  ...
  <tr>
    <td class="menuMetas"><ul>
      <li><a href="<%=request.getContextPath()%>/pages/est14.jsp">Performance management</a></li>
    </ul></td>
  </tr>
</table>
</td>
                      ...
                      <tr>
                        <td align="center" valign="top" class="texto"><p>Este modulo  hace referencia a las funciones y procesos de gesti&oacute;n claves y administrativas  dentro del CD y APT como el performance management, gesti&oacute;n de costos y desarrollo de  competencias, as&iacute; como otros aspectos importantes no especificadas en los tres  primeros m&oacute;dulos de este documento.</p>
                          <p align="center"><span class="tituloModulo">METAS PRINCIPALES</span><br />
                            <a href="<%=request.getContextPath()%>/pages/est14.jsp">Performance management</a></p></td>
                      </tr>
                    </table></td>
                    <td>&nbsp;</td>
                  </tr>
