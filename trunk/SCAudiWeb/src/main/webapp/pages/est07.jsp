...
<table border="0" align="center" cellpadding="2" cellspacing="0">
  ...
  <tr>
    <td valign="top"><span class="menuMetas"><ul>
      ...
      <ol start="7">
        <li>Limpieza de Veh&iacute;culos</li>
        ...
        <li><a href="est11.html">Control del tiempo de atenci&oacute;n de recargas para veh&iacute;culos de reparto</a></li>
      </ol>
                ...
                <td valign="top"><table border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td valign="top"><table width="460" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="10">
                          <tr>
                            ...
                            <td class="nombreestandar">Limpieza de Veh&iacute;culos.</td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto" >El buen estado de conservaci&oacute;n y limpieza de la unidad brinda seguridad adem&aacute;s de una adecuada imagen de la compa&ntilde;&iacute;a.  Por ejemplo, vidrio roto y basura en los camiones desestabilizan los pallets y las cajas cargadas, y pueden crear riesgos de inestabilidad y causar accidentes.</td>
                      </tr><tr>
                      ...
                      <tr>
                        <td><a href="evidencias/7.1.xls" target="_blank"><img src="images/ic_excel.gif" alt="7.1.xls" width="75" height="71" border="0" /></a></td>
                      </tr>
                       <tr>
                        <td><a href="evidencias/PTA 7 9 10.XLS" target="_blank"><img src="images/ic_excel.gif" alt="PTA 7 9 10.XLS" width="75" height="71" border="0" /></a></td>
                      </tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Dos o m&aacute;s camiones que llevan carga, evidencian falta de limpieza interior y/o exterior en la salida del CD/APT al mercado y durante los procesos de carga.<br /></li>
                            </ol></td></tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Un Cami&oacute;n que lleva carga, evidencia falta de limpieza interior y/o exterior en la salida del CD/APT al mercado y durante los procesos de carga</li>
                        </ol></td></tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Todos los camiones propios y terceros se mantienen limpios interna y externamente a la salida del CD/APT al mercado y durante los procesos de carga. </li>
                          <li> Se mantienen registros de inspecci&oacute;n de camiones limpios en la salida del CD/APT al mercado y durante los procesos de carga. </li>
                          </ol></td></tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Evidencia de comunicaci&oacute;n al personal propio y tercero respecto a los efectos de camiones sin limpieza adecuada.</li></ol></td></tr><tr><td valign="top"><p><span class="texto"><img src="images/spacer.gif" width="71" height="10" /></span></p>                          </td>
                      </tr>
                    </table></td>
                    <td>&nbsp;</td>
                  </tr>
