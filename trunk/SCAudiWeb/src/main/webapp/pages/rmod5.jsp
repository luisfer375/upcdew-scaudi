                  ...
                  <tr>
                    <td background="../images/bg_menutopinterna.gif"><table border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td><a href="../pages/rmod1.jsp"><img src="../images/mnI_mod1.gif" name="mod1" width="92" height="64" border="0" id="mod1"/></a></td>
                          <td><img src="../images/mnI_mod1_2.gif" name="mod1_2" width="19" height="64" id="mod1_2" /></td>
                          <td><a href="../pages/rmod2.jsp"><img src="../images/mnI_mod2.gif" name="mod2" width="106" height="64" border="0" id="mod2" /></a></td>
                          <td><img src="../images/mnI_mod2_3.gif" name="mod2_3" width="19" height="64" id="mod2_3" /></td>
                          <td><a href="../pages/rmod3.jsp"><img src="../images/mnI_mod3.gif" name="mod3" width="102" height="64" border="0" id="mod3"/></a></td>
                          <td><img src="../images/mnI_mod3_4.gif" name="mod3_4" width="20" height="64" id="mod3_4" /></td>
                          <td><a href="../pages/rmod4.jsp"><img src="../images/mnI_mod4.gif" name="mod4" width="71" height="64" border="0" id="mod4" /></a></td>
                          <td><img src="../images/mnI_mod4_5_roll5.gif" name="mod4_5" width="19" height="64" id="mod4_5" /></td>
                          <td><img src="../images/mnI_mod5_roll.gif" name="mod5" width="109" height="64" border="0" id="mod5"/></td>
                        </tr>
                    </table></td>
                  </tr>
                </table></td>
