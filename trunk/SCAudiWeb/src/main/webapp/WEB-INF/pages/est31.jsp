...
<li>Personal temporal en la flota de reparto </li>
                    ...
                    <td valign="top"><table width="460" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="10">
                          <tr>
                            <td width="10%" align="center" class="numero">31.</td>
                            <td class="nombreestandar">Personal temporal en la flota de reparto.</td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto" ><p>El excesivo uso de personal temporal compromete la calidad del servicio y por lo tanto debe ser minimizado.<br />
                          El ratio de personal temporal se calcula seg&uacute;n el siguiente ejemplo: a (30 temporales x 2 meses) / (100 permanentes x 12 meses) = 5%.Temporal: personal contratado ( planilla o no ) ante  vacaciones, enfermedad, semanas pico, etc.</p>
                          </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><table border="0" cellspacing="0" cellpadding="0">
                          <tr>
                        <td><a href="evidencias/31.1.msg" target="_blank"><img src="images/ic_mail.gif" alt="31.1.msg" width="75" height="71" border="0" /></a></td>
                        ...
                        <td><a href="evidencias/31.3.xls" target="_blank"><img src="images/ic_excel.gif" alt="31.3.xls" width="75" height="71" border="0" /></a></td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol><li> Se dispone de personal de reparto temporal (empleo estacional o peri&oacute;dico) por encima del 15% del personal permanente en los &uacute;ltimos 12 meses. <br />
                            </li>
                            </ol></td></tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Se dispone de personal temporal (empleo estacional o peri&oacute;dico) entre el 10% y 15% del personal permanente en los &uacute;ltimos 12 meses.</li>
                          </ol></td>
                      </tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Se dispone de personal temporal (empleo estacional o peri&oacute;dico) entre 5% y 10%  del personal permanente en los &uacute;ltimos 12 meses.</li>
                          </ol></td>
                      </tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Se dispone de personal temporal (empleo estacional o peri&oacute;dico) menor al 5% del personal permanente del movimiento anual. </li>
                          </ol></td>
                      </tr>
                      <tr>
