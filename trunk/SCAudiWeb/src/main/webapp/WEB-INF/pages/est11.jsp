...
<table border="0" align="center" cellpadding="2" cellspacing="0">
  ...
  <tr>
    <td valign="top"><span class="menuMetas"><ul>
      ...
      <li>Carga y descarga de veh&iacute;culos.</li>
    </ul></span><span class="menuMetasEst">
      <ol start="7">
        <li><a href="est07.html">Limpieza de Veh&iacute;culos</a></li>
        <li><a href="est08.html">Procedimientos para el control de la antig&uuml;edad del producto en el reparto</a></li>
        <li><a href="est09.html">Protecci&oacute;n del producto en procedimientos de carga y en los camiones</a></li>
        <li><a href="est10.html">Calidad asegurada del envase o empaque</a></li>
        <li>Control del tiempo de atenci&oacute;n de recargas para veh&iacute;culos de reparto</li>
      </ol>
                ...
                <td valign="top"><table border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td valign="top"><table width="460" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td class="subtitulo">CARGA Y DESCARGA DE VEH&Iacute;CULOS </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="10">
                          <tr>
                            ...
                            <td class="nombreestandar">Control del tiempo de atenci&oacute;n de recargas para veh&iacute;culos de reparto.</td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto" >El tiempo es a veces desperdiciado en el CD antes y despu&eacute;s de las entregas, lo cual representa costos ocultos.  El tiempo de atenci&oacute;n de las unidades (tiempo desde el ingreso hasta la salida del veh&iacute;culo en la recarga) debe medir desde el momento en que los camiones cruzan la puerta del CD, pasando por la carga y descarga, chequeo, operaciones administrativas hasta el momento en que cruza la puerta para salir del CD. Si el personal de reparto, luego de la recarga permanece en el CD para refrigerio, se considera como tiempo de fin de atenci&oacute;n en el momento que se haya finalizado los procesos administrativos y operativos de la recarga .</td>                      
                      </tr><tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><table border="0" cellspacing="0" cellpadding="0">
                          <tr>
                        <td><a href="evidencias/11.1.msg" target="_blank"></a></td>
                        ...
                        <td><a href="evidencias/11.3.xls" target="_blank"><img src="images/ic_excel.gif" alt="11.3.xls" width="75" height="71" border="0" /></a></td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> No existen registros ni an&aacute;lisis respecto al tiempo de atenci&oacute;n en el CD.<br />                          </li>                            </ol></td></tr>                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      <tr>
                        <td valign="top" background="images/bg_azul.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Diariamente se monitorea y analiza el tiempo de atenci&oacute;n en el CD </li>
                          <li> El Promedio del tiempo de atenci&oacute;n en el CD para camiones baranda o furg&oacute;n en los &uacute;ltimos 6 meses: &gt;= a 1,400cjs: entre 180 y 220 min. &lt; a 1,400cjs: entre 50 y 70 min.  </li>
                          <li>  El Promedio del tiempo de atenci&oacute;n en el CD para camiones parihueleros en los &uacute;ltimos 6 meses: &gt;= a 1,400cjs: entre 60 y 80 min. &lt; a 1,400cjs: entre 35 y 55 min. </li>
                          <li> Existe tendencia negativa del promedio de tiempo de atenci&oacute;n en el CD y la reducci&oacute;n es mayor al 5% en los &uacute;ltimos 6 meses .</li>
                        </ol></td></tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Diariamente se monitorea y analiza el Tiempo de atenci&oacute;n en el CD. </li>
                          <li> El Promedio del tiempo de atenci&oacute;n en el CD para camiones baranda o furg&oacute;n en los &uacute;ltimos 6 meses: &gt;= a 1,400cjs: entre 160 y 180 min. &lt; a 1,400cjs: entre 40 y 50 min.  </li>
                          <li>  El Promedio del tiempo de atenci&oacute;n en el CD para camiones parihueleros en los &uacute;ltimos 6 meses: &gt;= a 1,400cjs: entre 50 y 60 min. &lt; a 1,400cjs: entre 25 y 35 min . </li>
                        </ol></td></tr><tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li>  Diariamente se monitorea y analiza el Tiempo de atenci&oacute;n en el CD.  </li>
                          <li> El Promedio del tiempo de atenci&oacute;n en el CD para camiones baranda o furg&oacute;n en los &uacute;ltimos 6 meses: &gt;= a 1,400cjs: es menor que 160min. &lt; a 1,400cjs: es menor que 40min.  </li>
                          <li>  El Promedio del tiempo de atenci&oacute;n en el CD para camiones parihueleros en los &uacute;ltimos 6 meses: &gt;= a 1,400cjs: es menor que 50min. &lt; a 1,400cjs: es menor que 25min .</li>
                        </ol></td></tr><tr><td valign="top"><p><span class="texto"><img src="images/spacer.gif" width="71" height="10" /></span></p>                          </td>
                      </tr>
                    </table></td>
                    <td>&nbsp;</td>
                  </tr>
