...
<li>Administración de contratos con empresarios de reparto </li>
...
<li><a href="est33.html">Gestión y análisis del desempeño de los costos</a></li>
                    ...
                    <td valign="top"><table width="460" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="10">
                          <tr>
                            <td width="10%" align="center" class="numero">30.</td>
                            <td class="nombreestandar">Administraci&oacute;n de contratos con empresarios de reparto.</td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto" >Para asegurar un servicio de reparto seguro, la disponibilidad a contratistas de reparto, camiones propios y necesidades de trabajo temporal deben estar aseguradas. </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><a href="evidencias/30.1.xls" target="_blank"></a></td>
                      </tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol><li>2 o m&aacute;s contratos  de terceros (empresarios de reparto) no est&aacute;n disponibles, actualizados o incompletos (sin anexos).<br />
                            </li>
                            </ol></td></tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li>1 contrato de terceros (empresarios  de reparto) no est&aacute;n disponibles,  actualizados&nbsp; o incompletos (sin anexos). </li>
                          </ol></td>
                      </tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li>Todos los contratos de terceros  (empresarios de reparto) est&aacute;n &nbsp;disponibles,  actualizados y completos (incluido anexos). &nbsp;</li>
                          </ol></td>
                      </tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> El Gerente del CD est&aacute; capacitado en consideraciones legales y en administraci&oacute;n de contratos. </li>
                          <li> El Gerente del CD eval&uacute;a por lo menos dos veces al a&ntilde;o el desempe&ntilde;o de los terceros y el cumplimiento de los contratos. </li>
                        </ol></td>
                      </tr>
                      <tr>
        ...
        <td bgcolor="#FFFFFF"><img src="images/spacer.gif" alt="" width="44" height="45" /></td>
      </tr>
      <tr>
