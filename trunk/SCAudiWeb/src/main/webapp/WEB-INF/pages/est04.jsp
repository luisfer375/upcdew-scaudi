                  ...
                  <tr>
                    <td background="images/bg_menutopinterna.gif"><table border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td><img src="images/mnI_mod1_roll.gif" name="mod1" width="92" height="64" border="0" id="mod1" onmouseover="MM_swapImage('mod1','','images/mnI_mod1_roll.gif','mod1_2','','images/mnI_mod1_2_roll1.gif',1)" onmouseout="MM_swapImgRestore()" language="javascript" onclick="return mod1_onclick()" /></td>
  ...
  <tr>
    <td valign="top"><span class="menuMetas"><ul>
      <li>Planificaci&oacute;n de la carga.</li></ul></span><span class="menuMetasEst"><ol><li><a href="est01.html">Conocimiento profundo del cliente y de los servicios que &eacute;stos requieren.</a></li>
        ...
        <li>Servicios de reparto extraordinarios</li>
                ...
                <td valign="top"><table border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td valign="top"><table width="460" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td bgcolor="#535891" style="height: 1px"><img src="images/spacer.gif" width="150" height="1" /></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="10">
                          <tr>
                            ...
                            <td class="nombreestandar">Servicios  de reparto extraordinarios.</td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto" >A  pesar de que los d&iacute;as de entrega del reparto establecidos sirven para  planificar el reparto eficientemente, siempre ser&aacute;n necesarias entregas  urgentes para que los clientes tengan productos hasta la siguiente entrega.</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><table border="0" cellspacing="0" cellpadding="0">
                          <tr>
                        <td><a href="evidencias/4.1.msg" target="_blank"></a></td>
                        ...
                        <td><a href="evidencias/4.3.xls" target="_blank"><img src="images/ic_excel.gif" alt="4.3.xls" width="75" height="71" border="0" /></a></td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><p>No  existen recursos disponibles para servicios de reparto extraordinarios (fuera  de ruta). <br />
                        </p></td>
                      </tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      ...
                      <tr>
                        <td valign="top" class="texto"><p>Se  cuenta con veh&iacute;culos de ret&eacute;n o veh&iacute;culos de la flota de reparto disponibles  para pedidos extraordinarios; sin embargo su frecuencia de uso no es registrada  ni analizada</p></td>
                      </tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><p>Se  cuenta con veh&iacute;culos de ret&eacute;n o veh&iacute;culos de la flota de reparto disponibles  para pedidos extraordinarios, y su frecuencia de uso es registrada y analizada.</p></td></tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><p>Se  evidencian acciones emprendidas con los clientes con mayor cantidad de pedidos  extraordinarios persistentes de acuerdo con el siguiente esquema: situaci&oacute;n  actual, plan, ejecuci&oacute;n, impacto final.</p></td>
                      </tr>
                      <tr>
