...
<li>Imagen y condiciones de las instalaciones</li>
                    ...
                    <td valign="top"><table width="460" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="10">
                          <tr>
                            <td width="10%" align="center" class="numero">27.</td>
                            <td class="nombreestandar">Imagen y condiciones de las instalaciones.</td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto" >La imagen de SABMiller como proveedor preferido por su calidad de servicio es determinada por la estandarizaci&oacute;n de las instalaciones del CD.  En el caso de esperas en llamadas telef&oacute;nicas o en el CD, &eacute;stas debe ser lo m&aacute;s c&oacute;modamente posibles para los clientes. </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td><a href="evidencias/27.1.xls" target="_blank"><img src="images/ic_excel.gif" alt="27.1.xls" width="75" height="71" border="0" /></a></td>
                      </tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Ning&uacute;n s&iacute;mbolo corporativo ni material publicitario est&aacute; actualizado con los &uacute;ltimos dise&ntilde;os corporativos y  marcas en las &aacute;reas comunes del CD. </li>
                            <li> Ninguna oficina ni corredor est&aacute; se&ntilde;alizadas con nombres del personal y cargos. </li>
                            <li> El CD no tiene asientos para visitantes ni cuenta con materiales de lectura corporativa actualizada. <br />
                            </li>
                        </ol></td></tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> No todo s&iacute;mbolo corporativo y material publicitario est&aacute; actualizado con los &uacute;ltimos dise&ntilde;os corporativos y  marcas en las &aacute;reas comunes del CD. </li>
                          <li> No todas las oficinas y corredores est&aacute;n se&ntilde;alizadas adecuadamente con nombres del personal y cargos. </li>
                          <li> El CD tiene asientos para visitantes pero no cuenta con materiales de lectura corporativa actualizada. </li>
                        </ol></td>
                      </tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Todo s&iacute;mbolo corporativo y material publicitario est&aacute; actualizado con los &uacute;ltimos dise&ntilde;os corporativos y  marcas en las &aacute;reas comunes del CD. </li>
                          <li> Todas las oficinas y corredores est&aacute;n se&ntilde;alizados adecuadamente con nombres del personal y cargos. </li>
                          <li> El CD cuenta con asientos para visitantes y materiales de lectura corporativa actualizada. </li>
                        </ol></td>
                      </tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Se evidencia colaboraci&oacute;n del CD. con el personal de ventas para una comunicaci&oacute;n efectiva de las  &uacute;ltimas promociones, lanzamiento de marcas, y eventos locales para los clientes y personal del CD involucrado.</li>
                          </ol></td>
                      </tr>
                      <tr>
