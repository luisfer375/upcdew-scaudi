                ...
                <td valign="top"><table border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td valign="top"><table width="460" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="10">
                          <tr>
                            ...
                            <td class="nombreestandar">
                                Calidad asegurada del envase o empaque.</td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto" >Ning&uacute;n envase o empaque da&ntilde;ado o en mal estado debe ser entregado a los clientes. La calidad nunca se debe ver comprometida.</td>                      </tr><tr>
                      ...
                      <tr>
                        <td><a href="evidencias/10.1.xls" target="_blank"><img src="images/ic_excel.gif" alt="10.1.xls" width="75" height="71" border="0" /></a></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> 2 o m&aacute;s hallazgos de productos con envase o empaque da&ntilde;ados o en mal estado que han sido cargados para la entrega.<br />
                          </li>
                            </ol></td></tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li>Un hallazgo de productos con envase o empaque da&ntilde;ados o en mal estado que han sido cargados para la entrega.</li>
                        </ol></td></tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li>Ning&uacute;n hallazgo de productos con envase o empaque da&ntilde;ados o en mal estado que han sido cargados para la entrega. </li></ol></td></tr><tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      <tr>
                        <td valign="top" background="images/bg_azul.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Se evidencian procedimientos implementados para recuperar productos con envase o empaque da&ntilde;ados o en mal estado.</li></ol></td></tr><tr><td valign="top"><p><span class="texto"><img src="images/spacer.gif" width="71" height="10" /></span></p>                          </td>
                      </tr>
                    </table></td>
                    <td>&nbsp;</td>
                  </tr>
