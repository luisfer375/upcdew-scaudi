...
<li><a href="<%=request.getContextPath()%>/pages/est10.jsp">Comunicación al operador de transporte primario sobre posible demora en la atención de unidades</a></li>
                ...
                <td valign="top"><table border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td style="width: 36px"><img src="<%=request.getContextPath()%>/images/spacer.gif" width="24" height="31" /></td>
                  </tr>
                    ...
                    <td valign="top"><table width="460" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td><table border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td><a href="<%=request.getContextPath()%>/pages/evidencias/34.1.htm" target="_blank"><img src="<%=request.getContextPath()%>/images/ic_html.gif" alt="34.1.htm" width="75" height="71" border="0" /></a></td>
                            <td><a href="<%=request.getContextPath()%>/pages/evidencias/34.2.xls" target="_blank"><img src="<%=request.getContextPath()%>/images/ic_excel.gif" alt="34.2.xls" width="75" height="71" border="0" /></a></td>
                            <td><a href="<%=request.getContextPath()%>/pages/evidencias/34.3.xls" target="_blank"><img src="<%=request.getContextPath()%>/images/ic_excel.gif" alt="34.3.xls" width="75" height="71" border="0" /></a></td>
                            </tr>
                        </table>                          
                          </td>
                      </tr>
                  ...
                  <tr>
                    ...
                    <td><h1>&nbsp;</h1></td>
                    <td style="width: 36px"><img src="<%=request.getContextPath()%>/images/spacer.gif" width="24" height="25" /></td>
                  </tr>
                </table></td>
              </tr>
