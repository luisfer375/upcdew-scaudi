...
<table border="0" align="center" cellpadding="2" cellspacing="0">
  ...
  <tr>
    <td valign="top"><span class="menuMetas"><ul>
      ...
      <ol start="12">
        <li><a href="est12.html">Conocimiento de las metas y los objetivos del proceso de reparto</a></li>
...
<li>Comunicación a todos los clientes de los días de reparto establecidos</li>
                ...
                <td valign="top"><table border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td valign="top"><table width="460" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td class="subtitulo">DESPACHO DEL REPARTO </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="10">
                          <tr>
                            ...
                            <td class="nombreestandar">Registro,  actualizaci&oacute;n y cumplimiento de los d&iacute;as de reparto  establecidos. </td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto" >Establecer y comunicar el d&iacute;a de reparto permite una planificaci&oacute;n m&aacute;s efectiva para el cliente y para la compa&ntilde;&iacute;a, y adem&aacute;s balancea la carga de trabajo en la semana (evita picos).</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><table border="0" cellspacing="0" cellpadding="0">
                          <tr>
                        <td><a href="evidencias/15.1.xls" target="_blank"><img src="images/ic_excel.gif" alt="15.1.xls" width="75" height="71" border="0" /></a></td>
                        <td><a href="evidencias/15.2.xls" target="_blank"><img src="images/ic_excel.gif" alt="15.2.xls" width="75" height="71" border="0" /></a></td>
                          </tr>
                        </table></td>
                      </tr>                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li>
                            <p>1.  No todos los clientes activos tienen registrado el d&iacute;a de visita en la base de  datos (preventa, televenta, autoventa, etc.) </p>
                          </li>
                            </ol></td></tr><tr><td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      <tr>
                        <td valign="top" background="images/bg_azul.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li>Todos los clientes activos tienen registrado el d&iacute;a de visita en la base de  datos (preventa, televenta, autoventa, etc.), pero no todos se encuentran  actualizados. </li>
                          <li> Se lleva el indicador de entregas fuera de ruta, definido como: Contactos fuera de ruta / Total contactos programados.  </li>
                          <li> El indicador se encuentro por encima del 10% en los &uacute;ltimos 6 meses. .</li>
                        </ol></td></tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li>Se evidencia que todos los clientes activos tienen registrado y actualizado el d&iacute;a de visita en la base de datos (preventa, televenta, autoventa, etc.) .</li>
                          <li> El indicador de entregas fuera de ruta se halla entre el 5% y el 10% en los &uacute;ltimos 6 meses .</li>
                        </ol></td></tr><tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol><li> El indicador de entregas fuera de ruta se halla por debajo del 5% en los &uacute;ltimos 6 meses. </li>
