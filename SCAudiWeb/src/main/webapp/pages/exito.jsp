...
<table border="0" align="center" cellpadding="2" cellspacing="0">
  <tr>
    <td bgcolor="#262b54"><table border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        ...
        <td bgcolor="#383431"><table border="0" cellspacing="1" cellpadding="0">
          ...
          <tr>
            <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td background="images/bg_menutopinterna.gif"><table border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <td><a href="<%=request.getContextPath()%>/mod2.jsp"><img src="images/mnI_mod2.gif" name="mod2" width="106" height="64" border="0" id="mod2" /></a></td>
                            <td><img src="images/mnI_mod2_3.gif" name="mod2_3" width="19" height="64" id="mod2_3" /></td>
                            <td><a href="<%=request.getContextPath()%>/mod3.jsp"><img src="images/mnI_mod3.gif" name="mod3" width="102" height="64" border="0" id="mod3"/></a></td>
              ...
              <tr>
                <td width="165" height="19"><img src="images/spacer.gif" width="165" height="4" /></td>
                <td width="510">&nbsp;</td>
              </tr>
      ...
      <tr>
        <td colspan="3" valign="top" bgcolor="#FFFFFF"><p><img src="images/spacer.gif" width="174" height="32" />
		 </p><h2 align="center" class="style1">Operaci&oacute;n Grabada con exito.</p> </h2>
          </td>
      </tr>
    </table></td>
  </tr>
