...
<table border="0" align="center" cellpadding="2" cellspacing="0">
  ...
  <tr>
    <td valign="top"><span class="menuMetas"><ul>
      ...
      <li>Imagen y servicios del CD/APT. </li>
    </ul></span><span class="menuMetasEst">
      <ol start="24">
        <li> <a href="est24.html">Procedimientos, directivas y horas de trabajo del CD</a></li>
        <li>Reducción del tiempo de de atención para venta directa en el CD/APT </li>
<li><a href="est26.html">Procedimientos para el manejo de dinero en efectivo en las ventas directas en el CD</a></li>
<li><a href="est27.html">Imagen y condiciones de las instalaciones</a></li>
<li><a href="est28.html">Manejo efectivo de reclamos para clientes de venta directa en el CD</a></li>
                ...
                <td valign="top"><table border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td valign="top"><table width="460" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td class="subtitulo">IMAGEN Y SERVICIOS DEL CD/APT
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="10">
                          <tr>
                            <td width="10%" align="center" class="numero">25.</td>
                            <td class="nombreestandar">Reducci&oacute;n del tiempo de de atenci&oacute;n para venta directa en el CD/APT.</td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto" >Las ventas que implican recojo de productos en el CD/APT pueden ser lentas y por lo tanto, el cliente podr&iacute;a sentirse insatisfecho. Los esfuerzos para mejorar estos procesos incluyen el realizar pre pedidos o pre armados.  Este proceso debe medirse para determinar las demoras, (colas de espera), incluso, fuera del CD/APT.
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><table border="0" cellspacing="0" cellpadding="0">
                          <tr>
                        <td><a href="evidencias/25.1.msg" target="_blank"><img src="images/ic_mail.gif" alt="25.1.msg" width="75" height="71" border="0" /></a></td>
                        ...
                        <td><a href="evidencias/25.3.xls" target="_blank"><img src="images/ic_excel.gif" alt="25.3.xls" width="75" height="71" border="0" /></a></td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> No existen registros ni an&aacute;lisis respecto al tiempo de atenci&oacute;n en el CD/APT.
                              <br />
                                    </li>
                            </ol></td></tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Diariamente se monitorea y analiza el tiempo de atenci&oacute;n en el CD/APT </li>
                          <li> El Promedio del tiempo de atenci&oacute;n en el CD/APT para camiones baranda o furg&oacute;n en los &uacute;ltimos 6 meses: &gt;= a 1,400cjs: entre 180 y 220 min. &lt; a 1,400cjs: entre 50 y 70 min.  </li>
                          <li>  El Promedio del tiempo de atenci&oacute;n en el CD/APT para camiones parihueleros en los &uacute;ltimos 6 meses: &gt;= a 1,400cjs: entre 60 y 80 min. &lt; a 1,400cjs: entre 35 y 55 min. </li>
                          <li> Existe tendencia negativa del promedio de tiempo de atenci&oacute;n en el CD/APT
                              y la reducci&oacute;n es mayor al 5% en los &uacute;ltimos 6 meses.</li>
                        </ol></td>
                      </tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Diariamente se monitorea y analiza el Tiempo de atenci&oacute;n en el CD/APT. </li>
                          <li> El Promedio del tiempo de atenci&oacute;n en el CD/APT para camiones baranda o furg&oacute;n en los &uacute;ltimos 6 meses: &gt;= a 1,400cjs: entre 160 y 180 min. &lt; a 1,400cjs: entre 40 y 50 min.  </li>
                          <li>  El Promedio del tiempo de atenci&oacute;n en el CD/APT para camiones parihueleros en los &uacute;ltimos 6 meses: &gt;= a 1,400cjs: entre 50 y 60 min. &lt; a 1,400cjs: entre 25 y 35 min. </li>
                        </ol></td>
                      </tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li>  El Promedio del tiempo de atenci&oacute;n en el CD/APT para camiones baranda o furg&oacute;n en los &uacute;ltimos 6 meses: &gt;= a 1,400cjs: es menor que 160min. &lt; a 1,400cjs: es menor que 40min.  </li>
                          <li>  El Promedio del tiempo de atenci&oacute;n en el CD/APT para camiones parihueleros en los &uacute;ltimos 6 meses: &gt;= a 1,400cjs: es menor que 50min. &lt; a 1,400cjs: es menor que 25min.  </li>
                          <li> Se aplica una encuesta de satisfacci&oacute;n peri&oacute;dicamente relacionada con horarios de atenci&oacute;n, procedimientos y reglas para el servicio de venta y recojo en el CD/APT </li>
                        </ol></td>
                      </tr>
                      <tr>
