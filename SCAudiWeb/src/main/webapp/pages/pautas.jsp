...
<body onload="MM_preloadImages('images/mnI_mod1_2_roll2.gif','images/mnI_mod2_roll.gif','images/mnI_mod2_3_roll2.gif','images/mnI_mod2_3_roll3.gif','images/mnI_mod3_roll.gif','images/mnI_mod3_4_roll3.gif','images/mnI_mod3_4_roll4.gif','images/mnI_mod4_roll.gif','images/mnI_mod4_5_roll4.gif','images/mnI_mod4_5_roll5.gif','images/mnI_mod5_roll.gif','images/mnI_mod1_roll.gif','images/mnI_mod1_2_roll1.gif')">
                ...
                <td valign="top"><table border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td><table width="460" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td class="texto"><p><span class="subtitulo">Objetivo</span><br />
                          El  objetivo de los Est&aacute;ndares de Distribuci&oacute;n es desplegar en el personal de  distribuci&oacute;n las referencias de los niveles de competencia y desempe&ntilde;o en  servicio que nuestros clientes deber&iacute;an tener si queremos ser el proveedor  preferido en el mercado y ganar en el punto de venta. Estos principios explican  la calidad y eficiencia de nuestra ejecuci&oacute;n, que es donde nosotros tenemos que  superar a nuestros competidores.</p>
                          <p><span class="subtitulo">Est&aacute;ndares de Distribuci&oacute;n</span><br />
                            Tienen  como prop&oacute;sito cubrir todas las &aacute;reas de competencias y desempe&ntilde;o en los  procesos de Distribuci&oacute;n y han sido dise&ntilde;ados para sostener y soportar el logro  de las metas definidas por la Organizaci&oacute;n. </p>
                          <p><span class="subtitulo">M&oacute;dulos</span><br />
                            Los  Est&aacute;ndares de Distribuci&oacute;n han sido divididos en m&oacute;dulos, cada uno de las  cuales define las &aacute;reas claves de los procesos de Distribuci&oacute;n</p>
                          <p><span class="subtitulo">Metas y Est&aacute;ndares</span><br />
                            Estas  definen las metas y requerimientos de calidad contra los cuales debemos medir  el desempe&ntilde;o. El nivel de logros deber&aacute; ser medido en base al sistema de  evaluaci&oacute;n</p>
                          <p class="texto">&nbsp;</p>
                          </td>
                      </tr>
                    </table></td>
