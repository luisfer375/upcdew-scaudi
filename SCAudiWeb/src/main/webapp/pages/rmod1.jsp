            ...
            <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td background="../images/bg_menutopinterna.gif"><table border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          ...
                          <td><a href="../pages/rmod2.jsp"><img src="../images/mnI_mod2.gif" name="mod2" width="106" height="64" border="0" id="mod2" onmouseover="MM_swapImage('mod1_2','','../images/mnI_active1_2.gif','mod2','','../images/mnI_mod2_roll.gif','mod2_3','','../images/mnI_mod2_3_roll2.gif',1)" onmouseout="MM_swapImgRestore()" /></a></td>
                          ...
                          <td><a href="../pages/rmod4.jsp"><img src="../images/mnI_mod4.gif" name="mod4" width="71" height="64" border="0" id="mod4" onmouseover="MM_swapImage('mod3_4','','../images/mnI_mod3_4_roll4.gif','mod4','','../images/mnI_mod4_roll.gif','mod4_5','','../images/mnI_mod4_5_roll4.gif',1)" onmouseout="MM_swapImgRestore()" /></a></td>
              ...
              <tr>
                ...
                <td valign="top"><table border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="10" align="left" valign="top"><img src="../images/spacer.gif" width="10" height="31" /></td>
                    <td width="511"><img src="../images/spacer.gif" width="460" height="10" /></td>
                    </tr>
                  ...
                  <tr>
                    ...
                    <td valign="top"><table width="511" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td colspan="2" class="titulo"><span class="stitModulo">MODULO 1</span><br />
                          Reparto - Regi&oacute;n Lima</td>
                        </tr>
                      <tr>
                      ...
                      <tr>
                        <td width="250" align="left" valign="topo" class="subtitulo">RED F10                          
                          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="242" height="210" align="middle" id="FlashID">
                            ...
                            <object data="Charts/AngularGauge.swf" type="application/x-shockwave-flash" width="242" height="210" align="middle">
                              ...
                              <param name="wmode" value="opaque" />
                              <param name="swfversion" value="8.0.35.0" />
                              <param name="FlashVars" value="&dataURL=Data/M1LimaF10.xml" />
                              <param name="expressinstall" value="Scripts/expressInstall.swf" />
                        ...
                        <td width="250" align="left" valign="topo" class="subtitulo">RED F09
                          <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="242" height="210" align="middle" id="FlashID3">
                            ...
                            <object data="Charts/AngularGauge.swf" type="application/x-shockwave-flash" width="242" height="210" align="middle">
                              ...
                              <param name="wmode" value="opaque" />
                              <param name="swfversion" value="8.0.35.0" />
                              <param name="FlashVars" value="&dataURL=Data/M1LimaF09.xml" />
                              <param name="expressinstall" value="Scripts/expressInstall.swf" />
                              <!-- The browser displays the following alternative content for users with Flash Player 6.0 and older. -->
                              <div>
                                <h4>Content on this page requires a newer version of Adobe Flash Player.</h4>
                      ...
                      <tr>
                        <td colspan="2" align="center" valign="top" class="texto"><object id="FlashID2" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="500" height="300">
                          ...
                          <object type="application/x-shockwave-flash" data="Charts/MSCombi2D.swf" width="500" height="300">
                            <!--<![endif]-->
                            <param name="quality" value="high" />
                            <param name="FlashVars" value="&dataURL=Data/M1DetalladoLima.xml" />
                            <param name="wmode" value="opaque" />
                            <param name="swfversion" value="8.0.35.0" />
                            <param name="expressinstall" value="Scripts/expressInstall.swf" />
                            <!-- The browser displays the following alternative content for users with Flash Player 6.0 and older. -->
                      ...
                      <tr>
                        <td colspan="2" align="center" valign="top" class="texto"><p class="tituloModulo">IM&Aacute;GENES</p>
                          <table width="484" height="388" border="0" align="center">
                            <tr>
                              <td width="251" height="194" align="left" valign="top"><img src="fotos/Modulo 1/1.JPG" width="246" height="186" /></td>
                              <td width="223" align="left" valign="top"><img src="fotos/Modulo 1/2.JPG" width="246" height="186" /></td>
                            </tr>
                            <tr>
                              <td align="left" valign="top"><img src="fotos/Modulo 1/3.jpg" width="246" height="186" /></td>
                              <td align="left" valign="top"><img src="fotos/Modulo 1/4.JPG" width="246" height="186" /></td>
                            </tr>
                          </table></td>
                        </tr>
                      <tr>
