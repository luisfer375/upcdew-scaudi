  ...
  <tr>
    <td valign="top"><span class="menuMetas"><ul>
      <li>Planificaci&oacute;n de la carga.</li></ul></span><span class="menuMetasEst"><ol><li>Conocimiento profundo del cliente y de los servicios que &eacute;stos requieren.</li>
        <li><a href="<%=request.getContextPath()%>/pages/est1.jsp">Aseguramiento de altos est&aacute;ndares de servicio</a></li>
        <li><a href="<%=request.getContextPath()%>/pages/est1.jsp">Optimizaci&oacute;n del ruteo y generaci&oacute;n del programa de entrega a clientes</a></li>
        <li><a href="<%=request.getContextPath()%>/pages/est1.jsp">Servicios de reparto extraordinarios</a></li>
