...
<table border="0" align="center" cellpadding="2" cellspacing="0">
  <tr>
    <td bgcolor="#262b54"><table border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr>
        <td valign="top" bgcolor="#FFFFFF" style="width: 45px"><img src="<%=request.getContextPath()%>/images/spacer.gif" width="44" height="45" /></td>
        ...
        <td bgcolor="#383431"><table border="0" cellspacing="1" cellpadding="0">
          ...
          <tr>
            <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td width="165"><img src="<%=request.getContextPath()%>/images/spacer.gif" width="165" height="4" /></td>
                <td width="510"><img src="<%=request.getContextPath()%>/images/spacer.gif" width="510" height="4" /></td>
              </tr>
              <tr>
  ...
  <tr>
    <td align="center" background="<%=request.getContextPath()%>/images/bg_titmetas.gif"><img src="<%=request.getContextPath()%>/images/tit_metas.gif" width="121" height="30" /></td>
  </tr>
  <tr>
        ...
        <li><a href="<%=request.getContextPath()%>/pages/est5.jsp">Sistema planificado y efectivo de recojo de envases del mercado</a></li>
                ...
                <td valign="top"><table border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td style="width: 449px"><img src="<%=request.getContextPath()%>/images/spacer.gif" width="460" height="31" /></td>
                    <td><img src="<%=request.getContextPath()%>/images/spacer.gif" width="24" height="31" /></td>
                  </tr>
                  ...
                  <table width="460" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td valign="top" style="width: 453px">
                         <form id="FormularioEstandar1" name="FormularioEstandar1" method="post" action="<%=request.getContextPath()%>/EstandarServlet">
