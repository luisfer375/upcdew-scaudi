...
<table border="0" align="center" cellpadding="2" cellspacing="0">
  ...
  <tr>
    <td valign="top"><span class="menuMetas"><ul>
      ...
      <li>Entrega del producto.</li></ul></span><span class="menuMetasEst">
      <ol start="17">
        <li>Definición del tiempo de reparto a clientes especiales </li>
<li><a href="est18.html">Implementación de mejoras en el manejo del producto en locales de clientes especiales</a></li>
<li><a href="est19.html">Control de mermas de productos terminados en tránsito hacia el cliente</a></li>
<li><a href="est20.html">Manejo efectivo de reclamos para clientes del reparto</a></li>
                ...
                <td valign="top"><table border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td valign="top"><table width="460" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td class="subtitulo" style="width: 453px">ENTREGA DEL PRODUCTO </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" style="width: 453px"><table width="100%" border="0" cellspacing="0" cellpadding="10">
                          <tr>
                            <td width="10%" align="center" class="numero">17.</td>
                            <td class="nombreestandar">Definici&oacute;n del tiempo de reparto a clientes especiales.</td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto" style="width: 453px" >El seguimiento del tiempo que toma el reparto para entregar los productos a cada cliente especial es vital para la efectividad en la planificaci&oacute;n de la carga, administraci&oacute;n de la productividad y para la autogesti&oacute;n del reparto. Cada cliente especial requiere un &uacute;nico tiempo est&aacute;ndar. Se debe identificar la los clientes especiales (por ejemplo mayoristas, imagen) para &eacute;ste est&aacute;ndar. </td></tr>
                      <tr>
                      ...
                      <tr>
                        <td><a href="evidencias/17.1.xls" target="_blank"><img src="images/ic_excel.gif" alt="17.1.xls" width="75" height="71" border="0" /></a></td>
                      </tr>
                      <tr>
                        <td valign="top" style="width: 453px"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      ...
                      <tr>
                        <td valign="top" class="texto" style="width: 453px"><ol><li> No se ha definido, ni es medido el tiempo de reparto por cliente especial.</li></ol></td></tr>
                      <tr>
                        <td valign="top" style="width: 453px"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto" style="width: 453px"><ol>
                          <li> Se ha establecido el tiempo de reparto por cada cliente especial. </li>
                          <li> Los tiempos de reparto definidos no han sido usados en la programación diaria del
                              reparto.</li>
                            <li>El tiempo de reparto no es medido en todas las entregas y se lleva parcialmente
                                el registro correspondiente.</li>
                        </ol></td></tr>
                      <tr>
                        <td valign="top" style="width: 453px"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      ...
                      <tr>
                        <td valign="top" class="texto" style="width: 453px"><ol>
                          <li> Se ha establecido el tiempo de reparto por cada cliente especial. </li>
                            <li>Los tiempos de reparto son usados en la programación diaria del reparto y además
                                han sido &nbsp;analizados y revisados en los últimos 6 meses. </li>
                            <li>El tiempo de reparto es medido en cada entrega y se lleva el registro correspondiente.</li>
                        </ol></td></tr>
                      <tr>
                        <td valign="top" style="width: 453px"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      ...
                      <tr>
                        <td valign="top" class="texto" style="width: 453px"><ol>
                          <li> El desempe&ntilde;o del Tiempo de ciclo de reparto por cliente muestra mejora continua respecto al a&ntilde;o anterior  (en un nivel acumulado) de m&aacute;s del 5% en los &uacute;ltimos 6 meses.</li></ol></td></tr>
                      <tr>
