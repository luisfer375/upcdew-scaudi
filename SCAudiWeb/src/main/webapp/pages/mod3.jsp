...
<table border="0" align="center" cellpadding="2" cellspacing="0">
  ...
  <tr>
    <td class="menuMetas"><ul>
      <li><a href="<%=request.getContextPath()%>/pages/est11.jsp">Planificaci&oacute;n  del mantenimiento</a> <br />
      </li>
    </ul></td>
  </tr>
</table>
  ...
  <p align="center"><span class="tituloModulo">METAS PRINCIPALES</span><br />
    <a href="<%=request.getContextPath()%>/pages/est11.jsp">Planificaci&oacute;n  del mantenimiento</a> <br />
  </p></td></tr>
                    </table></td>
                    <td>&nbsp;</td>
                  </tr>
