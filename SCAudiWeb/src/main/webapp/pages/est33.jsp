...
<table border="0" align="center" cellpadding="2" cellspacing="0">
  ...
  <tr>
    <td valign="top"><span class="menuMetas"><ul>
      ...
      <ol start="29">
        <li><a href="est29.html">Planificación de la flota de reparto y de la tripulación</a> </li>
...
<li>Gestión y análisis del desempeño de los costos</li>
      </ol>
      </span></td>
  </tr>
</table>
                    ...
                    <td valign="top"><table width="460" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="10">
                          <tr>
                            <td width="10%" align="center" class="numero">33.</td>
                            <td class="nombreestandar">Gesti&oacute;n y an&aacute;lisis del desempe&ntilde;o de los costos.</td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto" >Los altos niveles de actividad en distribuci&oacute;n y la facilidad con la cual los est&aacute;ndares de  desempe&ntilde;o y los costos pueden ser comprometidos, indican que el desempe&ntilde;o y los costos deben ser controlados diariamente y las acciones correctivas deben de tomarse oportunamente.</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><table border="0" cellspacing="0" cellpadding="0">
                          <tr>
                        <td><a href="evidencias/33.1.msg" target="_blank"><img src="images/ic_mail.gif" alt="33.1.msg" width="75" height="71" border="0" /></a></td>
                        ...
                        <td><a href="evidencias/33.3.xls" target="_blank"><img src="images/ic_excel.gif" alt="33.3.xls" width="75" height="71" border="0" /></a></td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol><li> Falta de un sistema de control mensual de la eficiencia del reparto (indicadores de desempe&ntilde;o) </li>
                            <li> Los KPIs (indicadores de desempe&ntilde;o) no son analizados de manera constante. <br />
                            </li>
                        </ol></td></tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Los siguientes KPI&acute;s son monitoreados mensual y anualmente: 
                            <ol type="a">
                              <li> % de transporte en cami&oacute;n propio, tercero o del cliente. </li>
                              <li> Hl. repartidos por cami&oacute;n x d&iacute;a c. Hl. repartidos por salida al mercado. </li>
                              <li> Hl. repartidos x tripulante  (considera empresario, chofer, auxiliares) x cami&oacute;n x d&iacute;a </li>
                              <li> % de utilizaci&oacute;n de flota (Cjs cargadas del d&iacute;a / Capacidad en Cjs del cami&oacute;n). </li>
                              <li> Hl / contactos x cami&oacute;n x d&iacute;a repartidos (propio y tercero) </li>
                              <li> Rendimiento de combustible  Km/gal </li>
                              <li> km / Hl (propio y tercero)</li>
                              <li>  S/. (costo directo de reparto) / Hl repartidos </li>
                            </ol>
                          </li>
                          </ol></td>
                      </tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li>  El desempe&ntilde;o de la gesti&oacute;n de distribuci&oacute;n es regularmente analizada y existen acciones definidas e implementadas.</li>
                          <li> Se analiza y la eval&uacute;a las causas para los 2 KPI&acute;s que se encuentran m&aacute;s alejados de la meta. </li>
                          <li> Se compara y analiza la tendencia de 3 KPI&acute;s elegidos (actual vs. A&ntilde;o anterior), conclusi&oacute;n grafica y apropiadamente dirigida. </li>
                        </ol></td>
                      </tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Se evidencia un m&iacute;nimo 5 KPIs dentro de la meta establecida. </li>
                          <li> Se muestra ejemplos de acciones tomadas para mejorar por lo menos un KPI elegido de acuerdo con el siguiente esquema: situaci&oacute;n, plan de acci&oacute;n, ejecuci&oacute;n, impacto final. </li>
                        </ol></td>
                      </tr>
                      <tr>
