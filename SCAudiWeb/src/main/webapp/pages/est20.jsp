...
<li>Manejo efectivo de reclamos para clientes del reparto</li>
                    ...
                    <td valign="top"><table width="460" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="10">
                          <tr>
                            <td width="10%" align="center" class="numero">20.</td>
                            <td class="nombreestandar">Manejo efectivo de reclamos para clientes del reparto.</td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto" >Un sistema efectivo de reclamos tiene que demostrar el compromiso servir con calidad y empat&iacute;a al cliente. El cliente debe ser informado acerca del n&uacute;mero telef&oacute;nico del CD y el nombre de la persona que recepcionar&aacute; el reclamo. Se debe establecer un formato adecuado para este fin. </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td><a href="evidencias/20.1.xls" target="_blank"><img src="images/ic_excel.gif" alt="20.1.xls" width="75" height="71" border="0" /></a></td>
                      </tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol><li> Se reciben los reclamos pero no se registran o no existe un procedimiento para su manejo.</li>
                            </ol></td></tr><tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Existe un sistema para el manejo de reclamos pero no es comunicado al mercado. </li>
                          <li> La comunicaci&oacute;n al cliente con la soluci&oacute;n al reclamo excede los 2 d&iacute;as &uacute;tiles.</li></ol></td></tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Existe un sistema para el manejo de reclamos implementado y comunicado al mercado. </li>
                          <li> La comunicaci&oacute;n al cliente con la soluci&oacute;n al reclamo no excede los 2 d&iacute;as &uacute;tiles. </li>
                        </ol></td></tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Existe un sistema para el manejo de reclamos implementado y comunicado al mercado.</li>
                          <li> Los reclamos son analizados y se toman medidas preventivas. </li>
                          <li> El nivel de reclamos es menor que en el a&ntilde;o pasado. </li>
                        </ol></td></tr>
                      <tr>
