...
<li>Definición de ventanas de atención para clientes especiales</li>
      </ol>
                ...
                <td valign="top"><table border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td valign="top"><table width="460" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="10">
                          <tr>
                            ...
                            <td class="nombreestandar">Definici&oacute;n de ventanas de atenci&oacute;n para clientes especiales.</td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto" >Los clientes especiales podr&iacute;an no recibir al cami&oacute;n de reparto cuando llega fuera de su horario de atenci&oacute;n o podr&iacute;an no realizar los pagos pendientes. Un rango aceptable para la ventana horaria de atenci&oacute;n puede ser entre 1 hora hasta 3 o 4 horas.  Se debe identificar la los clientes especiales (por ejemplo mayoristas, imagen) para &eacute;ste est&aacute;ndar. </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td><a href="evidencias/16.1.xls" target="_blank"><img src="images/ic_excel.gif" alt="16.1.xls" width="75" height="71" border="0" /></a></td>
                      </tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li>  No est&aacute;n establecidas las ventanas horarias de atenci&oacute;n con todos los clientes especiales.</li></ol></td></tr><tr><td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      <tr>
                        <td valign="top" background="images/bg_azul.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Est&aacute;n establecidas las ventanas horarias de atenci&oacute;n con todos los clientes especiales.  </li>
                          <li> Se evidencian entre el 2% y el 5% de casos de llegada del reparto fuera de la ventana horaria de atenci&oacute;n, en los &uacute;ltimos 6 meses.</li>
                        </ol></td></tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Est&aacute;n establecidas las ventanas horarias de atenci&oacute;n con todos los clientes especiales. </li>
                          <li> Se evidencian casos por debajo del 2% de llegada del reparto fuera de la ventana horaria de atenci&oacute;n en los &uacute;ltimos 6 meses. </li>
                        </ol></td></tr><tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Est&aacute;n establecidas las ventanas horarias de atenci&oacute;n con todos los clientes especiales. </li>
                          <li> Se evidencian casos por debajo del 2% y en reducci&oacute;n constante de llegada del reparto fuera de la ventana horaria de atenci&oacute;n en los &uacute;ltimos 6 meses. </li>
