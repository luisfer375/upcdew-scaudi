...
<table border="0" align="center" cellpadding="2" cellspacing="0">
  <tr>
    <td bgcolor="#262b54"><table border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr>
        <td width="44" valign="top" bgcolor="#FFFFFF"><img src="images/spacer.gif" width="44" height="45" /></td>
        <td width="677" align="right" valign="bottom" bgcolor="#FFFFFF">&nbsp;</td>
        <td width="140" bgcolor="#FFFFFF"><img src="images/spacer.gif" width="44" height="45" /></td>
      </tr>
      <tr>
  ...
  <tr>
    <td valign="top"><span class="menuMetas"><ul>
      ...
      <ol start="21">
        <li> Los documentos del reparto y del transporte son firmados. </li>
<li><a href="est22.html"> Control de la  efectividad del reparto</a></li>
                ...
                <td valign="top"><table border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td valign="top"><table width="460" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td class="subtitulo" style="height: 14px">PROCESOS ADMINISTRATIVOS DEL REPARTO - DESPACHO</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="10">
                          <tr>
                            <td width="10%" align="center" class="numero">21.</td>
                            <td class="nombreestandar">Los documentos del reparto y transporte son firmados.</td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto" >Los documentos de reparto que no han sido firmados no pueden ser usados para prop&oacute;sitos legales, lo cual hace dif&iacute;cil resolver disputas de pago y causar discusiones innecesarias con clientes.  Para los documentos de consignaci&oacute;n y venta al cr&eacute;dito la firma del cliente es necesaria para reconocimiento de la obligaci&oacute;n contra&iacute;da y de la recepci&oacute;n de producto. Para los documentos del venta al contado, la firma del cliente es necesaria para el reconocimiento de recepci&oacute;n de producto. Estos procedimientos evitan contingencias tributarias y legales.<br />
                            <br />
                            Los documentos de transporte deben ser firmados en todas sus etapas, para evitar
                            contingencias durante el traslado de la mercadería.<br />
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><table border="0" cellspacing="0" cellpadding="0">
                          <tr>
                        <td><a href="evidencias/21.1.doc" target="_blank"><img src="images/ic_word.gif" alt="21.1.doc" width="75" height="71" border="0" /></a></td>
                        <td><a href="evidencias/21.2.doc" target="_blank"><img src="images/ic_word.gif" alt="21.2.doc" width="75" height="71" border="0" /></a></td>
                        <td><a href="evidencias/21.3.doc" target="_blank"><img src="images/ic_word.gif" alt="21.3.doc" width="75" height="71" border="0" /></a></td>
                        <td><a href="evidencias/21.4.htm" target="_blank"><img src="images/ic_word.gif" alt="21.4.htm" width="75" height="71" border="0" /></a></td>
                        <td><a href="evidencias/21.5.xls" target="_blank"><img src="images/ic_excel.gif" alt="21.5.xls" width="75" height="71" border="0" /></a></td>
                        <td><a href="evidencias/21.6.xls" target="_blank"><img src="images/ic_excel.gif" alt="21.6.xls" width="75" height="71" border="0" /></a></td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol><li> M&aacute;s de un documento de reparto o de transporte (G.R, Factura, Boleta,
                            etc.) no presenta firma durante controles aleatorios realizados en los &uacute;ltimos 6 meses.
                                    </li>
                            </ol></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Un documento de reparto  o de transporte (G.R, Factura, Boleta, etc.) no presenta firma durante controles aleatorios realizados en los &uacute;ltimos 6 meses.</li></ol></td></tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Para CD : Todos los documentos de entrega de reparto y de transporte ( G.R, Facturas, Boletas etc.) presentan firma durante controles aleatorios realizados en los &uacute;ltimos 6 meses.</li>
                          </ol></td>
                      </tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li>Existe un control ordenado, actualizado y seguro para garantizar  las firmas en los documentos del reparto y de transporte para los CDs. </li>
                          </ol></td>
                      </tr>
                      <tr>
