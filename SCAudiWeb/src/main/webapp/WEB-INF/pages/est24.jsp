...
<table border="0" align="center" cellpadding="2" cellspacing="0">
  ...
  <tr>
    <td valign="top"><span class="menuMetas"><ul>
      ...
      <ol start="24">
        <li>Procedimientos, directivas y horas de trabajo del CD </li><li><a href="est25.html">Reducción del tiempo de de atención para venta directa en el CD/APT</a></li>
                ...
                <td valign="top"><table border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td valign="top"><table width="460" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td class="subtitulo">IMAGEN Y SERVICIOS DEL CD/APT</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="10">
                          <tr>
                            <td width="10%" align="center" class="numero">24.</td>
                            <td class="nombreestandar">Procedimientos, directivas y horas de trabajo del CD </td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto" >Cada Cliente Interno y Externo debe ser informado acerca de los procesos de atenci&oacute;n del CD. En el caso de que los clientes soliciten productos fuera del horario de atenci&oacute;n habitual, es importante considerar horarios de atenci&oacute;n ampliados si fuera necesario. </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td><a href="evidencias/24.1.xls" target="_blank"><img src="images/ic_excel.gif" alt="24.1.xls" width="75" height="71" border="0" /></a></td>
                      </tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> No  existe una gu&iacute;a para clientes desarrollada y adaptada al CD conteniendo  informaci&oacute;n b&aacute;sica acerca de procedimientos, personal (incluyendo nombres) y  sus&nbsp; responsabilidades as&iacute; como horarios  de atenci&oacute;n.<br />
                            </li>
                            </ol></td></tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li>Existe una gu&iacute;a para clientes desarrollada y adaptada al  CD conteniendo informaci&oacute;n b&aacute;sica acerca de procedimientos, personal  (incluyendo nombres) y sus&nbsp;  responsabilidades as&iacute; como horarios de  atenci&oacute;n. </li>
                          <li>Los procedimientos no han  sido son publicados en un lugar accesible para todos los empleados y clientes.</li></ol></td>
                      </tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li>Existe una gu&iacute;a para clientes desarrollada y adaptada al CD conteniendo informaci&oacute;n b&aacute;sica  acerca de: procedimientos, personal (incluyendo nombres) y sus&nbsp; responsabilidades as&iacute; como horarios de atenci&oacute;n. </li>
                          <li>Los procedimientos son publicados en un lugar accesible  para todos los empleados y clientes.</li>
                            </ol></td>
                      </tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> La gu&iacute;a est&aacute; distribuida entre clientes con informaci&oacute;n actualizada (se evidencia el cargo por la recepci&oacute;n de este documento).</li>
                          </ol></td>
                      </tr>
                      <tr>
