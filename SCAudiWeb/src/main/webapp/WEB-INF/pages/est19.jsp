...
<li>Control de mermas de productos terminados en tránsito hacia el cliente</li>
                    ...
                    <td valign="top"><table width="460" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="10">
                          <tr>
                            <td width="10%" align="center" class="numero">19.</td>
                            <td class="nombreestandar">Control de mermas de productos terminados en tr&aacute;nsito hacia el cliente.</td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto" >Las mermas en tr&aacute;nsito (faltantes y desmedros) generan pedidos no atendidos, a menos que un env&iacute;o especial sea programado para cubrir las mermas. Los productos da&ntilde;ados en tr&aacute;nsito comprometen la confiabilidad del servicio y pueden afectar negativamente el stock en el mercado.</td></tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td><a href="evidencias/19.2.xls" target="_blank"><img src="images/ic_excel.gif" alt="19.2.xls" width="75" height="71" border="0" /></a></td>
                        <td><a href="evidencias/19.3.xls" target="_blank"><img src="images/ic_excel.gif" alt="19.3.xls" width="75" height="71" border="0" /></a></td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol><li> Las mermas en tr&aacute;nsito no son controladas diariamente.</li>
                            <li> No todas las mermas ocurridas en tr&aacute;nsito son registradas y archivadas </li>
                        </ol></td></tr><tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Las mermas en tr&aacute;nsito son controladas diariamente, y el promedio de los &uacute;ltimos 6 meses es mayor a 0.04%.  </li>
                          <li> Todas las mermas ocurridas en tr&aacute;nsito son registradas y archivadas. </li></ol></td></tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Las mermas en tr&aacute;nsito son controladas diariamente, y el promedio de los &uacute;ltimos 6 meses es menor a 0.04%. </li>
                          <li> Todas las mermas ocurridas en tr&aacute;nsito son registradas y archivadas. </li></ol></td></tr>
                      <tr><td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      <tr>
                        <td valign="top" background="images/bg_azul.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Las memas en tr&aacute;nsito controladas diariamente y el promedio de los &uacute;ltimos 6 meses es menor a 0.02%. </li>
                          <li> Todas las mermas ocurridas generan un archivo de registro </li>
                        </ol></td></tr>
                      <tr>
