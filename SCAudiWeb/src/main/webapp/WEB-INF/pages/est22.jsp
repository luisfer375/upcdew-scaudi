...
<table border="0" align="center" cellpadding="2" cellspacing="0">
  ...
  <tr>
    <td valign="top"><span class="menuMetas"><ul>
      ...
      <li>Procesos administrativos del reparto - despacho. </li>
    </ul></span><span class="menuMetasEst">
      <ol start="21">
        <li><a href="est21.html"> Los documentos del reparto son firmados.</a></li>
<li> Control de la  efectividad del reparto</li>
<li><a href="est23.html"> Gestión de cobranza durante el reparto </a></li>
      </ol>
      ...
      <li><a href="est29.html">Administraci&oacute;n de recursos.</a></li>
                ...
                <td valign="top"><table border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td style="width: 448px"><img src="images/spacer.gif" width="460" height="31" /></td>
                    <td><img src="images/spacer.gif" width="24" height="31" /></td>
                  </tr>
                  
                  <tr>
                    <td>&nbsp;</td>
                    <td valign="top" style="width: 448px"><table width="460" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                      ...
                      <tr>
                        <td class="subtitulo">PROCESOS ADMINISTRATIVOS DEL REPARTO - DESPACHO</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="10">
                          <tr>
                            <td width="10%" align="center" class="numero">22.</td>
                            <td class="nombreestandar">Control de la  efectividad del reparto.</td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto" >El retorno de producto terminado es costoso y perjudica el servicio. A menudo es ocasionado por errores en pedidos, errores en la carga de productos o por problemas relacionados con la calidad. Se debe minimizar a los clientes no atendidos (no recibieron producto) en la operaci&oacute;n de reparto. Todos los esfuerzos deben estar orientados a lograr altos niveles efectividad del reparto (correcto SKU, correcta cantidad y correcta calidad).</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><table border="0" cellspacing="0" cellpadding="0">
                          <tr>
                        <td><a href="evidencias/22.1.msg" target="_blank"><img src="images/ic_mail.gif" alt="22.1.msg" width="75" height="71" border="0" /></a></td>
                        ...
                        <td><a href="evidencias/22.3.xls" target="_blank"><img src="images/ic_excel.gif" alt="22.3.xls" width="75" height="71" border="0" /></a></td>
                          </tr>
                        </table></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol><li> No se ha implementado un procedimiento para monitorear la efectividad del reparto. </li>
                            <li> Se utiliza el indicador de efectividad del reparto (clientes atendidos / clientes programados) y est&aacute; en promedio por debajo del 90% en los &uacute;ltimos 6 meses.</li>
                        </ol></td>
                      </tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li>  Existe un procedimiento para monitorear la efectividad del reparto y se cuenta con la siguiente informaci&oacute;n de los clientes no atendidos (no recibieron producto): a. Cliente, N&deg; de comprobante de pago, fecha, SKU y cantidad. b. Raz&oacute;n de retorno: pedido incorrecto, carga incorrecta, producto extraviado, problemas de calidad. </li>
                          <li> El indicador de efectividad del reparto est&aacute; en promedio entre 90% y 94% en los &uacute;ltimos 6 meses .</li>
                        </ol></td></tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      </tr>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> Existe un procedimiento para monitorear la efectividad del reparto y se cuenta informaci&oacute;n actualizada. </li>
                          <li> El indicador efectividad del reparto est&aacute; en promedio entre 94% y 98% en los &uacute;ltimos 6 meses. </li>
                          <li> El an&aacute;lisis de las causas de no efectividad de reparto est&aacute; canalizado y las recomendaciones est&aacute;n entregadas. </li>
                        </ol></td>
                      </tr>
                      <tr>
                        <td valign="top"><img src="images/spacer.gif" width="71" height="10" /></td>
                      ...
                      <tr>
                        <td valign="top" class="texto"><ol>
                          <li> El Indicador efectividad del reparto est&aacute; por encima del 98% en los &uacute;ltimos 6 meses. </li>
                          <li> Existen evidencias de al menos 3 acciones tomadas para incrementar la efectividad del reparto de acuerdo con el siguiente esquema: situaci&oacute;n inicial, plan de acci&oacute;n, ejecuci&oacute;n, impacto final </li>
                        </ol></td>
                      </tr>
                      <tr>
